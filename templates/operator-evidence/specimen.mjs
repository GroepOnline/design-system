...
function document(title, body, script = "") {
  return `<!doctype html>
<!-- Generated by scripts/build-operator-template.mjs. Edit specimen.mjs/components.mjs. -->
<html lang="nl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f7f6f5"><title>${title}</title><link rel="stylesheet" href="tokens.css"></head><body>${body}${script}</body></html>\n`;
}
